...
from game_agent import custom_score_4
...
def main():
    ...
    test_agents = [Agent(CustomPlayer(score_fn=custom_score, **CUSTOM_ARGS), "Student"),
                   ...
                   Agent(CustomPlayer(score_fn=custom_score_1, **CUSTOM_ARGS), "Student_coef"),
                   Agent(CustomPlayer(score_fn=custom_score_2, **CUSTOM_ARGS), "Student_coef_p"),
                   Agent(CustomPlayer(score_fn=custom_score_3, **CUSTOM_ARGS), "Student_coef_1_p"),
                   Agent(CustomPlayer(score_fn=custom_score_4, **CUSTOM_ARGS), "Student_coef_05_p")]
    #test_agents = [
